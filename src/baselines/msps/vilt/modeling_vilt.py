...
class TextEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
        ...
        if self.position_embedding_type == "absolute":
            ...
            position_embeddings = torch.nn.functional.interpolate(position_embeddings.view(1, 1, 40, 768),
                                                                  size=(embeddings.shape[-2], 768),
    ...
    def forward(self, hidden_states, attention_mask=None, head_mask=None, output_attentions=False,
        ...
        if prompt_type == 'input':
            ...
            if learnt_p:
                ...
                prompts_v = missing_aware_prompt[:, P:]
            else:
...
class ViltAttention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask=None, head_mask=None, output_attentions=False,
        ...
        self_outputs = self.attention(hidden_states, attention_mask, head_mask, output_attentions,
                                      missing_aware_prompt=missing_aware_prompt, prompt_type=prompt_type, learnt_p=learnt_p)
...
class ViltLayer(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask=None, head_mask=None, output_attentions=False,
        ...
        self_attention_outputs = self.attention(
            ...
            missing_aware_prompt=missing_aware_prompt,
